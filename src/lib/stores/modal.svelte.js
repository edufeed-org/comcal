/**
 * @typedef {'none' | 'login' | 'privateKey' | 'settings' | 'profile' | 'eventDetails' | 'createCalendar' | 'calendarEvent' | 'ambUpload' | 'signup' | 'createCommunity' | 'editCommunity' | 'webcalQRCode'} ModalType
 */
